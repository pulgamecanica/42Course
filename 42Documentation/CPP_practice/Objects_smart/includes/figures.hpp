...
class Circle {						//_____________________________
	...
	public:						//___.%%%%O%%%%._______________
		Circle(point, int, char);		//____.%%%%%%%.___O:center_____
		bool	belongs_to(point);		//_____-%%%%%-____/:radius(r)__
		int	area(void){return(PI * r * r);};//______.%%%.__________________
...
class Rectangle {					//_____________________________
	...
	public:						//______ꓶ|%%%%%%%%%%%%%|__|____
		Rectangle(point, int, int, char);	//_____/_|%%%%%%%%%%%%%|__|h___
		bool	belongs_to(point);		//____/__|%%%%%%%%%%%%%|__|____
		char	get_chr(void);			//___/___|%%%%%%%%%%%%%|__|____
		int	area(void){return(w * h);};	//_rtc___L-------------⅃__v____
		~Rectangle();				//_____________________________
};							//_____________________________
...
//		constructor implemented			//_____________________________
