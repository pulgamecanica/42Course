...
// http://www.cplusplus.com/reference/map/map/value_cmp/
...
namespace ft {
    ...
    public:
        ...
        /*
         * value compare Class took from: http://www.cplusplus.com/reference/map/map/value_cmp/
        ...
        void swap(RedBlackTree& x) {
            i_swap(_size, x._size);
            i_swap(_first, x._first);
            i_swap(_root, x._root);
            i_swap(_last, x._last);
            i_swap(_alloc, x._alloc);
        }
                ...
                while (z != _root && z->color == B_RED && z->parent->color == B_RED) {
                    ...
                    if (parent == grandpa->left) {
                        ...
                        if (is_validnode(uncle) && uncle->color == B_RED) {
                            ...
                            ft::i_swap(parent->color, grandpa->color);
                        }
                    }
