...
int main() {
    ...
    char* const arg[2] = {"/home/pulgamecanica/Desktop/my_webserv/utils/CGI_Scripts/Python_CGI/hello.py", NULL};
    ...
    if (pid == 0)
    {
       ...
       execve("/home/pulgamecanica/Desktop/my_webserv/utils/CGI_Scripts/Python_CGI/hello.py", arg, env);
       perror ("Didn't work");
       exit(2);
    }
    wait(NULL);
