...
ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm& param): Form("shrubbery creation", 145, 137), target(param.target) {}

ShrubberyCreationForm::ShrubberyCreationForm(const std::string& str): Form("shrubbery creation", 145, 137), target(str) {}
