...
RobotomyRequestForm::RobotomyRequestForm(const RobotomyRequestForm& param): Form("robotomy request", 72, 45), target(param.target) {}

RobotomyRequestForm::RobotomyRequestForm(const std::string& str): Form("robotomy request", 72, 45), target(str) {}
