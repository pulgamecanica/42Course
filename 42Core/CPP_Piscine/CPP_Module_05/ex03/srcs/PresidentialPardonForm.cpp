...
PresidentialPardonForm::PresidentialPardonForm(const PresidentialPardonForm& param): Form("presidential pardon", 25, 5), target(param.target) {}

PresidentialPardonForm::PresidentialPardonForm(const std::string& str): Form("presidential pardon", 25, 5), target(str) {}
