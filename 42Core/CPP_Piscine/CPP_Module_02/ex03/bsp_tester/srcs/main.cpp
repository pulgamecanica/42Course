...
/*	int xMouse, yMouse;	*/
	...
	Point j(rand() % WINDOW_W, rand() % WINDOW_H);
	Point k(rand() % WINDOW_W, rand() % WINDOW_H);
	Point m(rand() % WINDOW_W, rand() % WINDOW_H);
	Point n(rand() % WINDOW_W, rand() % WINDOW_H);
	Point l(rand() % WINDOW_W, rand() % WINDOW_H);
	Point o(rand() % WINDOW_W, rand() % WINDOW_H);
...
/*		SDL_Renderer *mouse_target = SDL_CreateRenderer(window_stats, -1, 0);	*/
		...
		draw_triangle(renderer, j, k, m);
		draw_triangle(renderer, n, l, o);
		...
		draw_point(j, 2, renderer);
		draw_point(k, 2, renderer);
		draw_point(m, 2, renderer);
		draw_point(n, 2, renderer);
		draw_point(l, 2, renderer);
		draw_point(o, 2, renderer);
